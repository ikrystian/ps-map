...
CREATE TABLE "ExpertiseCategory" (
    ...
    CONSTRAINT "ExpertiseCategory_parentId_fkey" FOREIGN KEY ("parentId") REFERENCES "ExpertiseCategory" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
INSERT INTO "new_LawFirm" ("accountManagerId", "adres", "aktywna", "autoRenewal", "callaPolska", "createdAt", "dataPakietuDo", "dataPakietuOd", "edukacja", "filmYouTube", "galeriaZdjec", "godzinyOtwarcia", "id", "imieKontakt", "kodPocztowy", "kolejnoscMultimedia", "konwersja", "krs", "latitude", "linkFacebook", "linkInstagram", "linkLinkedIn", "linkTikTok", "linkTwitter", "logo", "longitude", "mainCategoryId", "miasto", "nazwa", "nazwa", "nazwiskoKontakt", "nip", "numerTelefonu", "numerTelefonu2", "oirpMiasto", "oirpStatus", "oirpWpis", "okladkaFilmu", "onlineOnly", "opis", "oraMiasto", "oraStatus", "oraWpis", "pakietSubskrypcji", "pozycjaRanking", "punktySaldo", "regon", "slowaKluczowe", "slug", "statusGodzinyOtwarcia", "stronaWww", "typ", "typInny", "typOferty", "unikatowyOpisUslugi", "updatedAt", "userId", "voivodeshipId", "wygraneOferty", "wyswietleniaProfilu", "zdjecieGlowne", "zgodaPrzetwarzanie", "zgodaRegulamin", "zlozoneOferty", "zweryfikowana") SELECT "accountManagerId", "adres", "aktywna", "autoRenewal", "callaPolska", "createdAt", "dataPakietuDo", "dataPakietuOd", "edukacja", "filmYouTube", "galeriaZdjec", "godzinyOtwarcia", "id", "imieKontakt", "kodPocztowy", "kolejnoscMultimedia", "konwersja", "krs", "latitude", "linkFacebook", "linkInstagram", "linkLinkedIn", "linkTikTok", "linkTwitter", "logo", "longitude", "mainCategoryId", "miasto", "nazwa", "nazwa", "nazwiskoKontakt", "nip", "numerTelefonu", "numerTelefonu2", "oirpMiasto", "oirpStatus", "oirpWpis", "okladkaFilmu", "onlineOnly", "opis", "oraMiasto", "oraStatus", "oraWpis", "pakietSubskrypcji", "pozycjaRanking", "punktySaldo", "regon", "slowaKluczowe", "slug", "statusGodzinyOtwarcia", "stronaWww", "typ", "typInny", "typOferty", "unikatowyOpisUslugi", "updatedAt", "userId", "voivodeshipId", "wygraneOferty", "wyswietleniaProfilu", "zdjecieGlowne", "zgodaPrzetwarzanie", "zgodaRegulamin", "zlozoneOferty", "zweryfikowana" FROM "LawFirm";
DROP TABLE "LawFirm";
...
-- CreateIndex
CREATE INDEX "ExpertiseCategory_parentId_idx" ON "ExpertiseCategory"("parentId");

-- CreateIndex
CREATE INDEX "ExpertiseCategory_aktywna_idx" ON "ExpertiseCategory"("aktywna");
