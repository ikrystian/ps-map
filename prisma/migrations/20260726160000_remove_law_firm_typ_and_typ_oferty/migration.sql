-- Usunięcie z LawFirm pól `typ` (forma prawna, enum LawFirmType),
-- `typInny` oraz `typOferty` (enum OfferType). SQLite nie ma DROP COLUMN
-- w tej formie, więc Prisma przebudowuje tabelę.
...
INSERT INTO "new_LawFirm" ("accountManagerId", "aktywna", "autoRenewal", "bieglySadowy", "bieglySadowyNazwaSadu", "calaPolska", "createdAt", "dataPakietuDo", "dataPakietuOd", "edukacja", "expertiseCategoryId", "filmYouTube", "galeriaZdjec", "godzinyOtwarcia", "id", "kolejnoscMultimedia", "konwersja", "krs", "linkFacebook", "linkInstagram", "linkLinkedIn", "linkTikTok", "linkTwitter", "logo", "mainCategoryId", "nazwa", "nip", "oirpMiasto", "oirpStatus", "oirpWpis", "okladkaFilmu", "onlineOnly", "opis", "oraMiasto", "oraStatus", "oraWpis", "packageDurationDays", "pakietSubskrypcji", "pozycjaRanking", "punktySaldo", "regon", "slowaKluczowe", "slug", "statusGodzinyOtwarcia", "stronaWww", "unikatowyOpisUslugi", "updatedAt", "userId", "wygraneOferty", "wyswietleniaProfilu", "zdjecieGlowne", "zgodaPrzetwarzanie", "zgodaRegulamin", "zlozoneOferty", "zweryfikowana") SELECT "accountManagerId", "aktywna", "autoRenewal", "bieglySadowy", "bieglySadowyNazwaSadu", "calaPolska", "createdAt", "dataPakietuDo", "dataPakietuOd", "edukacja", "expertiseCategoryId", "filmYouTube", "galeriaZdjec", "godzinyOtwarcia", "id", "kolejnoscMultimedia", "konwersja", "krs", "linkFacebook", "linkInstagram", "linkLinkedIn", "linkTikTok", "linkTwitter", "logo", "mainCategoryId", "nazwa", "nip", "oirpMiasto", "oirpStatus", "oirpWpis", "okladkaFilmu", "onlineOnly", "opis", "oraMiasto", "oraStatus", "oraWpis", "packageDurationDays", "pakietSubskrypcji", "pozycjaRanking", "punktySaldo", "regon", "slowaKluczowe", "slug", "statusGodzinyOtwarcia", "stronaWww", "unikatowyOpisUslugi", "updatedAt", "userId", "wygraneOferty", "wyswietleniaProfilu", "zdjecieGlowne", "zgodaPrzetwarzanie", "zgodaRegulamin", "zlozoneOferty", "zweryfikowana" FROM "LawFirm";
DROP TABLE "LawFirm";
