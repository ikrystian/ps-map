...
CREATE TABLE "new_Case" (
    ...
    "czekaNaAktywacjeEmail" BOOLEAN NOT NULL DEFAULT false,
...
INSERT INTO "new_Case" ("akceptujeKlauzule", "archivedAt", "budzetDo", "budzetOd", "categoryId", "cityId", "clientId", "createdAt", "doNegocjacji", "id", "imieNazwisko", "isArchived", "nazwaSprawy", "oczekiwanyTerminRealizacji", "opisSprawy", "preferowanyKontakt", "specjalizacja", "status", "telefonKontakt", "trybPilny", "typSprawy", "updatedAt", "voivodeshipId", "wybranaSpecyfikacja", "wybranadziedzinaPrawa", "zalaczniki", "zamknieto") SELECT "akceptujeKlauzule", "archivedAt", "budzetDo", "budzetOd", "categoryId", "cityId", "clientId", "createdAt", "doNegocjacji", "id", "imieNazwisko", "isArchived", "nazwaSprawy", "oczekiwanyTerminRealizacji", "opisSprawy", "preferowanyKontakt", "specjalizacja", "status", "telefonKontakt", "trybPilny", "typSprawy", "updatedAt", "voivodeshipId", "wybranaSpecyfikacja", "wybranadziedzinaPrawa", "zalaczniki", "zamknieto" FROM "Case";
DROP TABLE "Case";
