...
*/
-- Step 1: First add slug column as nullable
ALTER TABLE "LawFirm" ADD COLUMN "slug" TEXT;

-- Step 2: Generate slug for existing records based on nazwa + nip suffix
UPDATE "LawFirm"
SET "slug" = lower(
  replace(
    replace(
...
-- Step 3: Now redefine table to make slug NOT NULL and add unique constraint
...
INSERT INTO "new_LawFirm" ("adres", "aktywna", "callaPolska", "createdAt", "dataPakietuDo", "dataPakietuOd", "edukacja", "filmYouTube", "galeriaZdjec", "godzinyOtwarcia", "id", "imieKontakt", "kodPocztowy", "kolejnoscMultimedia", "konwersja", "krs", "linkFacebook", "linkInstagram", "linkLinkedIn", "linkTikTok", "linkTwitter", "logo", "miasto", "nazwa", "nazwa", "nazwiskoKontakt", "nip", "numerTelefonu", "numerTelefonu2", "oirpMiasto", "oirpStatus", "oirpWpis", "okladkaFilmu", "onlineOnly", "opis", "oraMiasto", "oraStatus", "oraWpis", "pakietSubskrypcji", "pozycjaRanking", "punktySaldo", "regon", "slug", "slowaKluczowe", "statusGodzinyOtwarcia", "stronaWww", "typ", "typInny", "typOferty", "unikatowyOpisUslugi", "updatedAt", "userId", "voivodeshipId", "wygraneOferty", "wyswietleniaProfilu", "zdjecieGlowne", "zgodaPrzetwarzanie", "zgodaRegulamin", "zlozoneOferty", "zweryfikowana") SELECT "adres", "aktywna", "callaPolska", "createdAt", "dataPakietuDo", "dataPakietuOd", "edukacja", "filmYouTube", "galeriaZdjec", "godzinyOtwarcia", "id", "imieKontakt", "kodPocztowy", "kolejnoscMultimedia", "konwersja", "krs", "linkFacebook", "linkInstagram", "linkLinkedIn", "linkTikTok", "linkTwitter", "logo", "miasto", "nazwa", "nazwa", "nazwiskoKontakt", "nip", "numerTelefonu", "numerTelefonu2", "oirpMiasto", "oirpStatus", "oirpWpis", "okladkaFilmu", "onlineOnly", "opis", "oraMiasto", "oraStatus", "oraWpis", "pakietSubskrypcji", "pozycjaRanking", "punktySaldo", "regon", "slug", "slowaKluczowe", "statusGodzinyOtwarcia", "stronaWww", "typ", "typInny", "typOferty", "unikatowyOpisUslugi", "updatedAt", "userId", "voivodeshipId", "wygraneOferty", "wyswietleniaProfilu", "zdjecieGlowne", "zgodaPrzetwarzanie", "zgodaRegulamin", "zlozoneOferty", "zweryfikowana" FROM "LawFirm";
DROP TABLE "LawFirm";
