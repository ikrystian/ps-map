...
Zespół Prosta Sprawa`,
    trescHtml: `<h1 style="font-family: 'Playfair Display', 'Georgia', serif; font-size: 26px; font-weight: bold; color: #3d3929; margin-top: 0; margin-bottom: 20px; text-align: center;">Witamy w ProstaSprawa!</h1>
...
<div style="background-color: #faf9f5; border: 1px solid #dad9d4; border-radius: 8px; padding: 20px; margin: 24px 0;">
  <strong style="color: #3d3929; font-weight: 600; display: block; margin-bottom: 8px;">Dane Twojego konta:</strong>
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
      <td style="padding: 6px 0; font-size: 14px; color: #83827d; font-weight: 500;" width="30%">E-mail:</td>
      <td style="padding: 6px 0; font-size: 14px; color: #3d3929; font-weight: 600;" width="70%">{email}</td>
    </tr>
  </table>
</div>

<h3 style="font-family: 'Playfair Display', 'Georgia', serif; font-size: 18px; font-weight: 600; color: #3d3929; margin-top: 24px; margin-bottom: 12px;">Co możesz teraz zrobić?</h3>
...
<div style="background-color: #faf9f5; border: 1px solid #dad9d4; border-radius: 8px; padding: 20px; margin: 24px 0;">
  <h3 style="font-family: 'Playfair Display', 'Georgia', serif; font-size: 16px; font-weight: 600; color: #3d3929; margin-top: 0; margin-bottom: 16px; border-bottom: 1px solid #dad9d4; padding-bottom: 8px;">Dane Twojego konta:</h3>
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
      <td style="padding: 6px 0; font-size: 14px; color: #83827d; font-weight: 500;" width="30%">Nazwa:</td>
      <td style="padding: 6px 0; font-size: 14px; color: #3d3929; font-weight: 600;" width="70%">{nazwa}</td>
    </tr>
    <tr>
      <td style="padding: 6px 0; font-size: 14px; color: #83827d; font-weight: 500; border-top: 1px solid #ede9de;">E-mail:</td>
      <td style="padding: 6px 0; font-size: 14px; color: #3d3929; font-weight: 600; border-top: 1px solid #ede9de;">{email}</td>
    </tr>
    <tr>
      <td style="padding: 6px 0; font-size: 14px; color: #83827d; font-weight: 500; border-top: 1px solid #ede9de;">NIP:</td>
      <td style="padding: 6px 0; font-size: 14px; color: #3d3929; font-weight: 600; border-top: 1px solid #ede9de;">{nip}</td>
    </tr>
    <tr>
      <td style="padding: 6px 0; font-size: 14px; color: #83827d; font-weight: 500; border-top: 1px solid #ede9de;">Status:</td>
      <td style="padding: 6px 0; font-size: 14px; color: #f59e0b; font-weight: 600; border-top: 1px solid #ede9de;">⏳ Oczekuje na weryfikację</td>
    </tr>
  </table>
</div>

<div style="background-color: #faf9f5; border-left: 4px solid #c96442; border-radius: 4px; padding: 16px; margin: 24px 0;">
  <strong style="color: #3d3929; font-weight: 600; display: block; margin-bottom: 6px;">ℹ️ Co się teraz wydarzy?</strong>
  <span style="font-size: 14px; color: #535146; line-height: 1.5; display: block;">Nasz zespół weryfikacyjny sprawdzi poprawność wprowadzonych danych rejestrowych oraz uprawnienia zawodowe w ciągu 1-2 dni roboczych. Po pozytywnej weryfikacji otrzymasz powiadomienie e-mail i będziesz mógł zacząć składać oferty.</span>
</div>

<h3 style="font-family: 'Playfair Display', 'Georgia', serif; font-size: 18px; font-weight: 600; color: #3d3929; margin-top: 24px; margin-bottom: 12px;">W międzyczasie uzupełnij swój profil:</h3>
<ul style="margin: 0 0 24px 0; padding-left: 20px; color: #535146; line-height: 1.6;">
...
Pozdrawiamy,
Zespół Prosta Sprawa`,
    trescHtml: `<h2 style="font-family: 'Playfair Display', 'Georgia', serif; font-size: 22px; font-weight: bold; color: #3d3929; margin-top: 0; margin-bottom: 16px;">Resetowanie hasła</h2>
...
<div style="text-align: center; margin: 30px 0;">
  <a href="{linkResetHasla}" class="btn" style="display: inline-block; background-color: #c96442; color: #ffffff !important; font-family: 'Poppins', ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, Arial, sans-serif; font-size: 15px; font-weight: 600; text-decoration: none; padding: 13px 28px; border-radius: 8px; box-shadow: 0 2px 4px rgba(201, 100, 66, 0.2); text-align: center;">Zresetuj hasło</a>
</div>

<div style="background-color: #faf9f5; border-left: 4px solid #c96442; border-radius: 4px; padding: 16px; margin: 24px 0;">
  <strong style="color: #3d3929; font-weight: 600; display: block; margin-bottom: 4px;">⚠️ Ważne informacje:</strong>
  <span style="font-size: 14px; color: #535146; line-height: 1.5; display: block;">Link do zresetowania hasła jest aktywny przez 1 godzinę. Jeśli to nie Ty wysyłałeś tę prośbę, po prostu zignoruj tę wiadomość – Twoje dotychczasowe hasło pozostanie w pełni bezpieczne i niezmienione.</span>
</div>`,
...
Pozdrawiamy,
Zespół Prosta Sprawa`,
    trescHtml: `<h2 style="font-family: 'Playfair Display', 'Georgia', serif; font-size: 22px; font-weight: bold; color: #3d3929; margin-top: 0; margin-bottom: 16px;">Potwierdź swój adres e-mail</h2>
...
<div style="text-align: center; margin: 30px 0;">
  <a href="{linkPotwierdzenia}" class="btn" style="display: inline-block; background-color: #c96442; color: #ffffff !important; font-family: 'Poppins', ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, Arial, sans-serif; font-size: 15px; font-weight: 600; text-decoration: none; padding: 13px 28px; border-radius: 8px; box-shadow: 0 2px 4px rgba(201, 100, 66, 0.2); text-align: center;">Potwierdź adres e-mail</a>
</div>

<div style="background-color: #faf9f5; border: 1px solid #dad9d4; border-radius: 8px; padding: 20px; margin: 24px 0; text-align: center;">
  <span style="font-size: 14px; color: #83827d; font-weight: 500; display: block; margin-bottom: 8px;">Twój kod weryfikacyjny:</span>
  <strong style="font-size: 26px; letter-spacing: 4px; color: #c96442; font-family: monospace;">{kod}</strong>
</div>

<div style="background-color: #faf9f5; border-left: 4px solid #c96442; border-radius: 4px; padding: 16px; margin: 24px 0;">
  <strong style="color: #3d3929; font-weight: 600; display: block; margin-bottom: 4px;">⚠️ Ważne informacje:</strong>
  <span style="font-size: 14px; color: #535146; line-height: 1.5; display: block;">Link oraz kod weryfikacyjny są ważne przez 24 godziny. Jeśli nie zakładałeś konta, po prostu zignoruj ten e-mail.</span>
</div>`,
