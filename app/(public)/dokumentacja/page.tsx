...
export default function DocsPage() {
  const sampleDocs = [
    ...
    { name: 'Panel kancelarii - główne', path: 'docs/[11][panel-kancelarii]glowne.md', description: 'Główne funkcje panelu kancelarii' },
    { name: 'Panel kancelarii - sprawy i oferty', path: 'docs/[12][panel-kancelarii]sprawy-i-oferty.md', description: 'Zarządzanie sprawami i ofertami' },
    { name: 'Panel kancelarii - zakres usług', path: 'docs/[13][panel-kancelarii]zakres-uslug.md', description: 'Zarządzanie zakresem usług' },
    { name: 'Panel kancelarii - blog', path: 'docs/[14][panel-kancelarii]blog.md', description: 'Funkcje bloga w panelu kancelarii' },
    { name: 'Panel kancelarii - certyfikaty', path: 'docs/[15][panel-kancelarii]certyfikaty.md', description: 'Zarządzanie certyfikatami' },
    { name: 'Panel kancelarii - dokumenty', path: 'docs/[16][panel-kancelarii]dokumenty.md', description: 'Zarządzanie dokumentami' },
    { name: 'Panel kancelarii - finansowe', path: 'docs/[17][panel-kancelarii]finansowe.md', description: 'Funkcje finansowe panelu kancelarii' },
    { name: 'Panel kancelarii - system punktów', path: 'docs/[18][panel-kancelarii]system-punktow.md', description: 'System punktowy w panelu kancelarii' },
    { name: 'Panel kancelarii - płatności', path: 'docs/[19][panel-kancelarii]platnosci.md', description: 'System płatności w panelu kancelarii' },
    { name: 'Panel kancelarii - komunikacja', path: 'docs/[20][panel-kancelarii]komunikacja.md', description: 'Komunikacja w panelu kancelarii' },
    { name: 'Panel kancelarii - program partnerski', path: 'docs/[21][panel-kancelarii]program-partnerski.md', description: 'Program partnerski dla kancelarii' },
