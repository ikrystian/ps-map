            ...
            <motion.div variants={itemVariants}>
              <Card variant="glass" className="rounded-2xl shadow-lg relative overflow-hidden">
                ...
                <CardHeader className="border-b border-border/20 py-4 px-6">
                  <CardTitle className="text-lg font-playfair text-foreground">Historia faktur</CardTitle>
                                ...
                                <div className="flex items-center justify-end">
                                  {isPdfReady(invoice) ? (
                                    ...
                                    <Button
                                      ...
                                      className="h-9 rounded-lg border border-border/50 text-muted-foreground text-xs gap-1.5 opacity-60 cursor-not-allowed"
                                    >
                          ...
                          <div className="flex items-center justify-end border-t border-border/5 pt-2.5">
                            {isPdfReady(invoice) ? (
                              ...
                              <Button
                                ...
                                size="sm"
                                disabled
                                className="h-8 rounded-lg border border-border/50 text-muted-foreground gap-1 text-sm opacity-60 cursor-not-allowed"
                              >
                                <Clock className="h-3.5 w-3.5" />
                                Oczekuje na KSeF
                              </Button>
