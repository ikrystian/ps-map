...
import { Calendar, Clock, FileText, Loader2, Mail, Trash2, User, Video, Sparkles, MessageCircle } from "lucide-react"
                      ...
                      <div className="flex flex-col gap-5 lg:flex-row lg:justify-between lg:items-center">
                        ...
                        <div className="flex flex-wrap gap-2.5 lg:flex-col lg:items-end flex-shrink-0">
                          ...
                          <Button
                            ...
                            className="w-full lg:w-auto h-9 px-4 border border-[#0da192]/20 bg-[#0da192]/5 text-[#0da192] hover:bg-[#0da192]/10 rounded-xl text-xs font-semibold transition-all"
                          >
