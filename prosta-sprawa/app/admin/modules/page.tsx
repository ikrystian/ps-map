...
import { Plus, Edit, Trash2, Search, Eye, Code, RefreshCw } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      <Dialog open={isPreviewDialogOpen} onOpenChange={setIsPreviewDialogOpen}>
        <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Podgląd modułu: {selectedModule?.name}</DialogTitle>
          </DialogHeader>
          {selectedModule && (
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold mb-2">Kod HTML:</h3>
                <pre className="bg-muted p-4 rounded-lg overflow-x-auto text-sm">
                  <code>{selectedModule.code}</code>
                </pre>
              </div>
              <div>
                <h3 className="font-semibold mb-2">Wykryte pola edytowalne:</h3>
                <div className="bg-muted p-4 rounded-lg">
                  {(() => {
                    ...
                    return parsed.fields.length > 0 ? (
                      ...
                      <p className="text-muted-foreground">Brak wykrytych pól edytowalnych</p>
                    )
                  })()}
                </div>
              </div>
