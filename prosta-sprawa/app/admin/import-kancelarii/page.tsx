...
export default function ImportKancelarii() {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      if (data.summary.success > 0) {
        toast.success(`Zaimportowano ${data.summary.success} kancelarii`)
      }

      if (data.summary.errors > 0) {
        toast.warning(`${data.summary.errors} kancelarii nie udało się zaimportować`)
      }
    } catch (error: any) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold">Import kancelarii z pliku JSON</h1>
        <p className="text-muted-foreground mt-2">
          Importuj kancelarie prawne z pliku JSON zawierającego pełne profile
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Jak przygotować plik JSON do importu kancelarii
          </CardDescription>
        </CardHeader>
  ...
  "lawFirms": [
    {
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Wybierz plik JSON zawierający dane kancelarii do zaimportowania
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-muted-foreground mt-2">
              Proszę czekać, trwa importowanie kancelarii...
            </p>
          </CardContent>
        </Card>
      )}
      ...
      {result && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Podsumowanie procesu importowania kancelarii
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            {result.results.success.length > 0 && (
              <Alert className="bg-green-50 border-green-200">
                ...
                <AlertTitle className="text-green-800">
                  Pomyślnie zaimportowane kancelarie
                </AlertTitle>
