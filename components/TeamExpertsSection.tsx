...
import { Users, MapPin, ArrowRight, ShieldCheck, Mail, Calendar } from "lucide-react"
...
const MOCK_POOL: Expert[] = [
  {
    ...
    categories: [{ category: { nazwa: "Prawo Rodzinne" } }, { category: { nazwa: "Prawo Cywilne" } }]
  },
  {
    id: "mock-2",
    slug: "jan-nowak",
    ...
    categories: [{ category: { nazwa: "Obsługa Firm" } }, { category: { nazwa: "Prawo Pracy" } }]
  },
  {
    id: "mock-3",
    ...
    categories: [{ category: { nazwa: "Prawo Karne" } }, { category: { nazwa: "Obrona w sądzie" } }]
  },
  {
    id: "mock-4",
    slug: "mateusz-wojcik",
    ...
    categories: [{ category: { nazwa: "Nieruchomości" } }, { category: { nazwa: "Prawo Budowlane" } }]
  },
  {
    id: "mock-5",
    ...
    categories: [{ category: { nazwa: "Mediacje" } }, { category: { nazwa: "Rozwody" } }]
  },
  {
    id: "mock-6",
    ...
    categories: [{ category: { nazwa: "Własność Intelektualna" } }, { category: { nazwa: "Prawo IT" } }]
  },
  {
    id: "mock-7",
    ...
    categories: [{ category: { nazwa: "Sprawy Frankowe" } }, { category: { nazwa: "Prawo Bankowe" } }]
  },
  {
    id: "mock-8",
    ...
    categories: [{ category: { nazwa: "Prawo Podatkowe" } }, { category: { nazwa: "Doradztwo Finansowe" } }]
  },
  {
    id: "mock-9",
    ...
    categories: [{ category: { nazwa: "Prawo Medyczne" } }, { category: { nazwa: "Odszkodowania" } }]
  },
  {
    id: "mock-10",
    ...
    categories: [{ category: { nazwa: "Prawo Spadkowe" } }, { category: { nazwa: "Prawo Cywilne" } }]
  },
  {
    id: "mock-11",
    ...
    categories: [{ category: { nazwa: "Prawo Administracyjne" } }, { category: { nazwa: "Obsługa Obywateli" } }]
  },
  {
    id: "mock-12",
    ...
    categories: [{ category: { nazwa: "RODO i E-commerce" } }, { category: { nazwa: "Prawo Konsumenckie" } }]
  },
  {
    id: "mock-13",
    ...
    categories: [{ category: { nazwa: "Odszkodowania" } }, { category: { nazwa: "Ubezpieczenia" } }]
  },
  {
    id: "mock-14",
    ...
    categories: [{ category: { nazwa: "Upadłość i Długi" } }, { category: { nazwa: "Restrukturyzacja" } }]
  },
  {
    id: "mock-15",
    ...
    categories: [{ category: { nazwa: "Ochrona Konsumenta" } }, { category: { nazwa: "Prawo Biznesowe" } }]
  },
  {
    id: "mock-16",
    slug: "artur-król",
    ...
    categories: [{ category: { nazwa: "Prawo Transportowe" } }, { category: { nazwa: "Obsługa Firm" } }]
  },
  {
    id: "mock-17",
    ...
    mainCategory: { nazwa: "Prawo Rodzinne" },
    categories: [{ category: { nazwa: "Prawo Rodzinne" } }, { category: { nazwa: "Alimenty" } }]
  },
  {
    id: "mock-18",
    slug: "konrad-wróbel",
    ...
    categories: [{ category: { nazwa: "Procesy Sądowe" } }, { category: { nazwa: "Podział Majątku" } }]
  },
  {
    id: "mock-19",
    slug: "adrianna-duda",
    ...
    categories: [{ category: { nazwa: "Prawo Autorskie" } }, { category: { nazwa: "Social Media Law" } }]
  },
  {
    id: "mock-20",
    slug: "robert-dudek",
    ...
    categories: [{ category: { nazwa: "Prawo Pracy" } }, { category: { nazwa: "Zwolnienia" } }]
  },
  {
    id: "mock-21",
    slug: "paulina-pawlak",
    ...
    categories: [{ category: { nazwa: "Venture Capital" } }, { category: { nazwa: "Fuzje i Przejęcia" } }]
  },
  {
    id: "mock-22",
    slug: "adrian-sikor",
    ...
    categories: [{ category: { nazwa: "Prawo Karne Skarbowe" } }, { category: { nazwa: "White-collar Crime" } }]
  },
  {
    id: "mock-23",
    ...
    categories: [{ category: { nazwa: "Prawo Budowlane" } }, { category: { nazwa: "Inwestycje" } }]
  },
  {
    id: "mock-24",
    ...
    categories: [{ category: { nazwa: "Szkody Komunikacyjne" } }, { category: { nazwa: "Konsument" } }]
  }
]
...
export default function TeamExpertsSection() {
    ...
    const fetchExperts = async () => {
      try {
        ...
        if (finalExperts.length < 24) {
          ...
          const shuffledMockPool = [...MOCK_POOL].sort(() => 0.5 - Math.random())
  ...
  const getInitials = (imie?: string | null, nazwisko?: string | null, nazwa?: string) => {
    if (imie && nazwisko) {
  ...
  return (
    <section className="relative w-full border-t border-zinc-900/60 bg-zinc-950/20 py-16 md:py-24 lg:py-28 overflow-hidden select-none">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#0f0f13_1px,transparent_1px),linear-gradient(to_bottom,#0f0f13_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] opacity-35 -z-10 pointer-events-none" />

      <div className="container mx-auto px-4 md:px-6 relative">
        {/* Header */}
        <div className="flex flex-col items-center text-center mb-4 space-y-4 mb-4">
          <Badge variant="outline" className="border-primary/20 text-primary bg-primary/5 px-4 py-1.5 text-xs font-semibold uppercase tracking-wider rounded-full shadow-[0_0_15px_rgba(var(--primary-rgb),0.07)]">
            <Users className="mr-2 h-3.5 w-3.5 inline text-primary animate-pulse" /> Nasi Eksperci
          </Badge>
          ...
          <p className="max-w-[750px] text-zinc-400 text-sm sm:text-base md:text-lg font-light leading-relaxed">
            Prezentujemy 24 losowo wyselekcjonowanych specjalistów z naszej bazy. Za każdym razem dobieramy inny zestaw ekspertów prawnych gotowych odpowiedzieć na Twoje potrzeby.
          </p>
        </div>
        ...
        {isLoading ? (
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {Array.from({ length: 24 }).map((_, i) => (
              <Card key={i} className="bg-zinc-900/40 border-zinc-800/50 p-6 flex flex-col justify-between h-[280px]">
                <div>
          ...
          >
            {experts.map((expert) => {
              ...
              const imieNazwisko = imie && nazwisko ? `${imie} ${nazwisko}` : null
              const displayName = imieNazwisko || expert.nazwaFirmy || expert.nazwa
              const roleName = expert.mainCategory?.nazwa || (expert.categories?.[0]?.category?.nazwa) || "Specjalista Prawny"
              ...
              const skills = expert.categories?.map(c => c.category.nazwa) || []
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-1">
                          ...
                          {expert.id.startsWith("mock-") === false && (
                            <ShieldCheck className="h-4.5 w-4.5 text-primary shrink-0" title="Zweryfikowany Ekspert" />
                          )}
                        </div>
