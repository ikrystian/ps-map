      ...
      >
            ...
            <CardContent className="p-6 md:p-8 space-y-6">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="space-y-3 max-w-2xl">
                  ...
                  <h2 className="text-2xl md:text-3xl font-semibold font-playfair text-foreground tracking-tight leading-snug">
                ...
                <div className="shrink-0 flex flex-col sm:flex-row md:flex-col gap-3">
                  <Button
                    asChild
                    className="h-11 px-6 bg-gradient-to-r from-primary to-[var(--primary-dark)] hover:from-[var(--primary-hover)] hover:to-primary text-white font-semibold rounded-xl shadow-md gap-2 border-t border-border group"
                  >
        ...
        <motion.div variants={itemVariants} className="space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div>
              <h3 className="text-lg font-semibold font-playfair text-foreground flex items-center gap-2">
                <Sparkles className="h-4 w-4 text-primary" />
                Jak będzie wyglądał Twój blog?
              </h3>
              <p className="text-muted-foreground text-xs font-light">Podgląd prezentacji artykułów dla Twoich klientów i w wynikach wyszukiwania</p>
            </div>

            {/* Toggle tabs */}
            <div className="flex items-center p-1 bg-card/60 border border-border/40 rounded-xl shrink-0">
              <button
          ...
          <Card className="border border-border/30 bg-card/30 backdrop-blur-md rounded-2xl p-6 relative overflow-hidden">
            {activePreviewTab === "google" ? (
              <div className="space-y-3 bg-background/80 p-5 rounded-xl border border-border/80">
                <div className="flex items-center gap-2 text-xs text-muted-foreground">
                  ...
                  <div className="flex flex-col">
                    <span className="text-foreground/80 font-medium text-[11px]">ProstaSprawa.pl › blog › jak-napisac-odwolanie</span>
                    <span className="text-muted-foreground text-[10px]">https://prostasprawa.pl/blog/jak-zabezpieczyc-majatek-kancelaria</span>
                  </div>
                </div>
                ...
                <p className="text-xs text-foreground/80 font-light leading-relaxed">
                  Autor: <strong className="text-foreground font-medium">Twoja Kancelaria Prawna</strong> · Ekspert ProstaSprawa.pl · Poznaj skuteczne metody ochrony majątku prywatnego, powiernictwo oraz struktury fundacji rodzinnej.
                </p>
              ...
              <div className="max-w-md mx-auto bg-card/60 border border-border rounded-2xl overflow-hidden p-5 space-y-4">
                ...
                <h4 className="text-base font-semibold font-playfair text-foreground">
        ...
        <motion.div variants={itemVariants} className="space-y-4">
          <div className="space-y-1">
            <h3 className="text-lg font-semibold font-playfair text-foreground">Dlaczego warto aktywować bloga?</h3>
            <p className="text-muted-foreground text-xs font-light">Kluczowe korzyści marketingowe i wizerunkowe dla Twojego profilu</p>
          </div>
            ...
            <Card className="border border-border/30 bg-card/25 backdrop-blur-md rounded-2xl shadow-sm hover:border-primary/30 transition-all duration-200">
              <CardHeader className="pb-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-base font-playfair text-foreground">Widoczność w Google (SEO)</CardTitle>
                    <CardDescription className="text-xs text-muted-foreground">Ruch organiczny bez stałych budżetów reklamowych</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="space-y-3 text-xs text-foreground/80 font-light leading-relaxed">
                <p>
            ...
            <Card className="border border-border/30 bg-card/25 backdrop-blur-md rounded-2xl shadow-sm hover:border-primary/30 transition-all duration-200">
              <CardHeader className="pb-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-base font-playfair text-foreground">Budowanie Autorytetu</CardTitle>
                    <CardDescription className="text-xs text-muted-foreground">Status wiodącego eksperta w swojej specjalizacji</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="space-y-3 text-xs text-foreground/80 font-light leading-relaxed">
            ...
            <Card className="border border-border/30 bg-card/25 backdrop-blur-md rounded-2xl shadow-sm hover:border-primary/30 transition-all duration-200">
              <CardHeader className="pb-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-base font-playfair text-foreground">Przewaga w Regionie</CardTitle>
                    <CardDescription className="text-xs text-muted-foreground">Lokalna i ogólnopolska dominacja rynkowa</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="space-y-3 text-xs text-foreground/80 font-light leading-relaxed">
            ...
            <Card className="border border-border/30 bg-card/25 backdrop-blur-md rounded-2xl shadow-sm hover:border-primary/30 transition-all duration-200">
              <CardHeader className="pb-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-base font-playfair text-foreground">Długofalowy Efekt (ROI)</CardTitle>
                    <CardDescription className="text-xs text-muted-foreground">Treści pracujące na Twój sukces 24/7</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="space-y-3 text-xs text-foreground/80 font-light leading-relaxed">
        ...
        <motion.div variants={itemVariants}>
          <Card className="border border-border/30 bg-card/25 backdrop-blur-md rounded-2xl shadow-sm">
            <CardHeader className="pb-4 border-b border-border/20">
              <CardTitle className="text-lg font-playfair text-foreground">Co zawiera moduł bloga w pakiecie BIZNES?</CardTitle>
            ...
            <CardContent className="pt-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="flex items-start gap-3 p-3.5 rounded-xl bg-card/40 border border-border/20 hover:border-primary/30 transition-colors">
                  <BookOpen className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                  <div>
                    <h4 className="text-xs font-semibold text-foreground">Nieograniczona publikacja</h4>
                    <p className="text-[11px] text-muted-foreground mt-0.5 font-light">Brak limitów artykułów, analiz prawnych i poradników</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3.5 rounded-xl bg-card/40 border border-border/20 hover:border-primary/30 transition-colors">
                  ...
                  <div>
                    <h4 className="text-xs font-semibold text-foreground">Zaawansowany Edytor Rich-Text</h4>
                    <p className="text-[11px] text-muted-foreground mt-0.5 font-light">Wygodne formatowanie paragrafów, nagłówków i grafik</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3.5 rounded-xl bg-card/40 border border-border/20 hover:border-primary/30 transition-colors">
                  ...
                  <div>
                    <h4 className="text-xs font-semibold text-foreground">Automatyczna optymalizacja SEO</h4>
                    <p className="text-[11px] text-muted-foreground mt-0.5 font-light">Przyjazne tagi Meta, przejrzysta struktura pod Google</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3.5 rounded-xl bg-card/40 border border-border/20 hover:border-primary/30 transition-colors">
                  ...
                  <div>
                    <h4 className="text-xs font-semibold text-foreground">Analityka czytelnictwa</h4>
                    <p className="text-[11px] text-muted-foreground mt-0.5 font-light">Licznik wyświetleń i śledzenie zainteresowania artykułami</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3.5 rounded-xl bg-card/40 border border-border/20 hover:border-primary/30 transition-colors">
                  ...
                  <div>
                    <h4 className="text-xs font-semibold text-foreground">Kategorie i tagi</h4>
                    <p className="text-[11px] text-muted-foreground mt-0.5 font-light">Precyzyjne organizowanie wpisów wg dziedzin prawa</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3.5 rounded-xl bg-card/40 border border-border/20 hover:border-primary/30 transition-colors">
                  ...
                  <div>
                    <h4 className="text-xs font-semibold text-foreground">Wyświetlanie na profilu</h4>
                    <p className="text-[11px] text-muted-foreground mt-0.5 font-light">Dedykowana zakładka Blog na Twojej wizytówce</p>
                  </div>
                </div>
              </div>
            </CardContent>
        ...
        <motion.div variants={itemVariants}>
          <Card className="border border-amber-500/20 bg-gradient-to-r from-card/40 via-amber-950/10 to-card/40 backdrop-blur-md rounded-2xl shadow-lg text-center p-6 md:p-8 space-y-4 relative overflow-hidden">
            ...
            <p className="text-xs text-foreground/80 max-w-lg mx-auto font-light leading-relaxed">
            ...
            <div className="pt-2 flex justify-center">
              <Button
                asChild
                className="h-11 px-8 bg-gradient-to-r from-primary to-[var(--primary-dark)] hover:from-[var(--primary-hover)] hover:to-primary text-white font-semibold rounded-xl shadow-lg gap-2 border-t border-border text-xs group"
              >
                <Link href="/panel-eksperta/pakiet">
                  <Zap className="h-4 w-4 text-amber-300 fill-amber-300" />
