      ...
      <Card id="tour-profil-logo" className="border border-border/30 bg-card/25 backdrop-blur-md rounded-2xl shadow-lg relative overflow-hidden transition-all duration-300">
        ...
        <CardContent className="pt-6">
          <div className="grid lg:grid-cols-12 gap-8 items-start">
            ...
            {/* Separator columns on larger screens */}
            <div className="hidden lg:block lg:col-span-1 h-full min-h-[180px] relative">
              <div className="absolute inset-y-0 left-1/2 -translate-x-1/2 w-[1px] bg-border/10" />
            </div>
