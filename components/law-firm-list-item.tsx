...
const AwardEmblem = () => (
    <div className="relative flex-shrink-0 select-none">
        <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-14 h-14 md:w-16 md:h-16">
            ...
            {/* Laurel Wreath */}
            <path d="M22 42C17 36 17 26 22 20M19 38C15 36 15 33 19 31M17 30C13 28 13 25 17 23M19 22C15 20 16 17 20 15M23 15C20 13 21 10 25 9" stroke="url(#goldGradient)" strokeWidth="1.5" strokeLinecap="round" />
            <path d="M42 42C47 36 47 26 42 20M45 38C49 36 49 33 45 31M47 30C51 28 51 25 47 23M45 22C49 20 48 17 44 15M41 15C44 13 43 10 39 9" stroke="url(#goldGradient)" strokeWidth="1.5" strokeLinecap="round" />

            {/* Center Seal */}
            <circle cx="32" cy="27" r="12" fill="#131313" stroke="url(#goldGradient)" strokeWidth="1.5" />
            <circle cx="32" cy="27" r="9" fill="none" stroke="url(#goldGradient)" strokeWidth="0.75" strokeDasharray="2 1" />

            {/* Checkmark inside V */}
            <path d="M28 27L31 30L36 23" stroke="url(#goldGradient)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />

            {/* Ribbon Banner at bottom */}
            <path d="M20 44L24 41H40L44 44L32 47L20 44Z" fill="#131313" stroke="url(#goldGradient)" strokeWidth="1.5" />
            <path d="M20 44V49L24 47L20 44Z" fill="#1d1d1d" stroke="url(#goldGradient)" strokeWidth="1" />
            <path d="M44 44V49L40 47L44 44Z" fill="#1d1d1d" stroke="url(#goldGradient)" strokeWidth="1" />

            <text x="32" y="45.5" fill="url(#goldGradient)" fontSize="5.5" fontWeight="bold" textAnchor="middle" letterSpacing="0.5" fontFamily="sans-serif">2024</text>
        </svg>
    </div>
)
...
const OraIcon = () => (
    <svg className="w-4 h-4 text-white" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="12" cy="12" r="8" stroke="currentColor" strokeWidth="0.5" strokeDasharray="1 1" />
        <path d="M12 7V17M9 17H15M8 10H16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
        <path d="M10 10.5C10 12 9 13.5 9 13.5M14 10.5C14 12 15 13.5 15 13.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
)
                        ...
                        <div className="absolute bottom-4 left-4 z-10">
                            <div className="bg-[#058c80] text-white px-3 py-2 rounded-lg flex items-center gap-3 shadow-lg border border-teal-500/20">
                                <span className="text-2xl font-bold font-sans tracking-tight leading-none">
                                    {lawFirm.avgRating > 0 ? lawFirm.avgRating.toFixed(1).replace(".", ",") : "5,0"}
                                </span>
                                <div className="flex flex-col justify-center">
                                    ...
                                    <span className="text-[10px] text-neutral-200 font-sans leading-none font-light">
                                        {lawFirm.reviewCount || 11} {getOpinieText(lawFirm.reviewCount || 11)}
                                    </span>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex items-center text-[#0db19f]">
                                        ...
                                        <span className="text-sm text-neutral-400 font-light truncate">
                                            {lawFirm.adres ? `${lawFirm.adres}, ${lawFirm.kodPocztowy} ${lawFirm.miasto}` : `${lawFirm.miasto}, ${lawFirm.voivodeship.nazwa}`}
                                        </span>
                                    </div>
                                </div>
                                <AwardEmblem />
