...
export function BusinessPackageWelcomeModal({
  ...
  return (
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent className="max-w-2xl border border-amber-500/20 bg-background p-6 shadow-2xl shadow-amber-500/5 backdrop-blur-xl md:p-8 text-foreground">
        ...
        <div className="my-6 space-y-4 rounded-2xl border border-border bg-card/50 p-5 md:p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
            <div className="flex gap-3">
              ...
              <div>
                <h5 className="font-semibold text-sm text-foreground">Zlecenia i kategorie bez limitu</h5>
                <p className="text-xs text-muted-foreground mt-1">Dostęp do wszystkich spraw i nieograniczona liczba specjalizacji.</p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div>
                <h5 className="font-semibold text-sm text-foreground">Wyróżnienie VIP "Skill Law Focus"</h5>
                <p className="text-xs text-muted-foreground mt-1">Twój profil otrzyma unikalną odznakę i będzie promowany na szczycie list.</p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div>
                <h5 className="font-semibold text-sm text-foreground">Maksymalny zasięg działania</h5>
                <p className="text-xs text-muted-foreground mt-1">Możliwość pozyskiwania klientów z 6 województw oraz 35 miast.</p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div>
                <h5 className="font-semibold text-sm text-foreground">Własny Blog Ekspercki</h5>
                <p className="text-xs text-muted-foreground mt-1">Publikuj artykuły i buduj pozycję lidera w swojej dziedzinie prawa.</p>
              </div>
            </div>
          </div>
