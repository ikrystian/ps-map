...
export function BlogPostsSlider({ blogPosts }: BlogPostsSliderProps) {
  ...
  return (
    <section className="py-12 lg:py-20 xl:py-24 bg-card border-t border-border/60 overflow-hidden">
      <div className="container mx-auto px-4 max-w-7xl relative">

        <div className="flex items-center justify-between gap-6 mb-4 lg:mb-12 px-1">
          <h2 className="font-playfair text-2xl md:text-3xl lg:text-[34px] font-normal text-foreground tracking-wide whitespace-nowrap">
          ...
          <div className="overflow-hidden">
            ...
            >
              {blogPosts.map((post) => (
                ...
                >
                  <div className="relative overflow-hidden rounded-2xl aspect-[2/3] bg-card shadow-xl border border-border/60">
                    ...
                    <div className="on-dark absolute inset-0 flex flex-col justify-end p-5 z-10">
                      {post.category?.nazwa && (
                      ...
                      <h3 className="font-semibold text-sm leading-snug line-clamp-3 text-foreground group-hover:text-foreground/90 transition-colors mb-3">
                        {post.tytul}
                      </h3>
                      <div className="flex items-center gap-2 overflow-hidden">
                        <div className="w-6 h-[1px] bg-primary transition-all duration-500 group-hover:w-12" />
                        <span className="text-[11px] font-medium text-foreground/60 group-hover:text-foreground/80 flex items-center gap-1 transition-colors">
                          Czytaj dalej
